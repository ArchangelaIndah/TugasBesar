...
import com.example.tubes.AddEditActivity
import com.example.tubes.MahasiswaActivity
...
class MahasiswaAdapter(private var mahasiswaList: List<Mahasiswa>, context: Context) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int){
        ...
        holder.btnDelete.setOnClickListener{
            ...
            materialAlertDialogBuilder.setTitle("Konfirmasi")
                ...
                .setPositiveButton("Hapus"){_, _ ->
                    if(context is MahasiswaActivity) mahasiswa.id?.let{ it1 ->
        ...
        holder.cvMahasiswa.setOnClickListener{
            ...
            if(context is MahasiswaActivity)
                context.startActivityForResult(i, MahasiswaActivity.LAUNCH_ADD_ACTIVITY)
