...
import com.example.tubes.adapters.MahasiswaAdapter
import com.example.tubes.api.MahasiswaApi
import com.example.tubes.models.Mahasiswa
...
class MahasiswaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fabAdd.setOnClickListener{
            val i = Intent(this@MahasiswaActivity, AddEditActivity::class.java)
        ...
        val stringRequest: StringRequest = object :
            StringRequest(Method.GET, MahasiswaApi.GET_ALL_URL, Response.Listener { response ->
                ...
                if(!mahasiswa.isEmpty())
                    Toast.makeText(this@MahasiswaActivity, "Data Berhasil Diambil!", Toast.LENGTH_SHORT ).show()
                else
                ...
                try{
                    ...
                    Toast.makeText(this@MahasiswaActivity, e.message, Toast.LENGTH_SHORT).show()
                }
            }){
